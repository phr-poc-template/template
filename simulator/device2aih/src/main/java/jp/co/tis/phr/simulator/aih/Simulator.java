...
import static jp.co.tis.phr.simulator.aih.IoTHubClient.sendMessage;

@Slf4j
public abstract class Simulator implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        IotHubMessage dm = (IotHubMessage) data.get(JOB_DATA);
        try {
            sendMessage(dm);
        } catch (IOException e) {
    ...
    protected <T extends IotHubMessage> void sendData(T deviceMessage) {
    ...
    protected <T extends IotHubMessage> void scheduleJob(T deviceMessage, String cronExpression) throws SchedulerException {
